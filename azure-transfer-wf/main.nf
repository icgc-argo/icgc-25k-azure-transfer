...
include { scoreDataTransfer as Transfer } from './wfpr_modules/github.com/icgc-argo/icgc-25k-azure-transfer/score-data-transfer@0.5.0/main.nf' params(transfer_params)
